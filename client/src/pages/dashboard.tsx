  ...
  return (
    <div className="flex h-screen bg-background">
      ...
      <main className="flex-1 overflow-y-auto">
          ...
          <div className="px-8 h-full flex items-center justify-between">
            ...
            <div className="flex items-center space-x-4">
              <div className="flex items-center space-x-2 px-4 py-2 bg-muted/50 rounded-lg border border-border/50 backdrop-blur-sm">
                <div
                  className={`w-2 h-2 rounded-full ${metrics.firehoseStatus.connected ? 'bg-success animate-pulse shadow-sm' : 'bg-destructive'}`}
                />
                <span className="text-sm font-medium font-mono">
                  Relay:{' '}
                  {metrics.firehoseStatus.connected
                    ? 'Connected'
                    : 'Disconnected'}
                </span>
              </div>
          ...
          <section className="p-8">
            <div className="mb-6">
              ...
              <p className="text-muted-foreground">
                Real-time AT Protocol relay event stream
              </p>
            </div>
                  ...
                  <div className="space-y-2">
                    ...
                    <div className="flex items-center justify-between">
                      ...
                      <span
                        ...
                        data-testid="text-identity-count"
                      >
                    ...
                    <div className="flex items-center justify-between">
                      ...
                      <span
                        ...
                        data-testid="text-account-count"
                      >
        ...
        {location === '/database' && (
          <section className="p-8 bg-muted/30">
            <div className="mb-6">
              ...
              <p className="text-muted-foreground">
                PostgreSQL schema optimized for AT Protocol data indexing
              </p>
            </div>
            <DatabaseSchema />
          </section>
        ...
        {location === '/api' && (
          <section className="p-8">
            <div className="mb-6">
              ...
              <p className="text-muted-foreground">
                Bluesky-compatible API implementation
              </p>
            </div>
            <ApiEndpoints />
          </section>
        ...
        {location === '/lexicons' && (
          <section className="p-8 bg-muted/30">
            <div className="mb-6">
              ...
              <p className="text-muted-foreground">
                Real-time schema validation and supported Lexicons
              </p>
            </div>
            <LexiconValidatorPanel
              total={metrics.eventsProcessed}
              valid={Math.floor(
                metrics.eventsProcessed * (1 - metrics.errorRate / 100)
              )}
              invalid={Math.floor(
                metrics.eventsProcessed * (metrics.errorRate / 100)
              )}
              errorRate={metrics.errorRate}
            />
          </section>
        ...
        {location === '/policy' && <InstancePolicyPage />}
          ...
          (session?.isAdmin ? (
            ...
            <section className="p-8">
              <Card className="border-destructive/50">
                ...
                <CardContent>
                  <p className="text-muted-foreground">
                    You do not have permission to access the Admin Control
                    Panel. This area is restricted to authorized administrators
                    only.
                  </p>
