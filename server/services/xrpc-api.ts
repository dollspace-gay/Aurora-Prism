...
export class XRPCApi {
  ...
  /**
   * @deprecated This method has been extracted to utils/serializers.ts
   * Use the standalone serializePosts function from utils instead
   * This wrapper is kept for backward compatibility with legacy code
   */
  private async serializePosts(
    ...
    const { serializePosts: utilSerializePosts } = await import(
      './xrpc/utils/serializers'
    );
    return utilSerializePosts(posts, viewerDid, req);
  }
