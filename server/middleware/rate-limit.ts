...
export const oauthLimiter = RATE_LIMIT_ENABLED
  ? rateLimit({
      windowMs: 15 * 60 * 1000, // 15 minutes
...
export const searchLimiter = RATE_LIMIT_ENABLED
  ? rateLimit({
      windowMs: 1 * 60 * 1000, // 1 minute
...
export const xrpcLimiter = RATE_LIMIT_ENABLED
  ? rateLimit({
      windowMs: 1 * 60 * 1000, // 1 minute
...
export const deletionLimiter = RATE_LIMIT_ENABLED
  ? rateLimit({
...
export const viteLimiter = RATE_LIMIT_ENABLED
  ? rateLimit({
      windowMs: 1 * 60 * 1000, // 1 minute
